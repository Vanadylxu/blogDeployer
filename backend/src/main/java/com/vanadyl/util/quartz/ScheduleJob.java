package com.vanadyl.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.vanadyl.entity.ScheduleJobLog;
import com.vanadyl.service.ScheduleJobService;
import com.vanadyl.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        com.vanadyl.entity.ScheduleJob scheduleJob = (com.vanadyl.entity.ScheduleJob) context.getMergedJobDataMap().get(com.vanadyl.entity.ScheduleJob.JOB_PARAM_KEY);
        //获取spring bean
