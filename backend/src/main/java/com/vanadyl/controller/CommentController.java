...
import com.vanadyl.annotation.AccessLimit;
import com.vanadyl.entity.User;
import com.vanadyl.model.dto.Comment;
...
import com.vanadyl.service.BlogService;
import com.vanadyl.service.CommentService;
import com.vanadyl.service.FriendService;
import com.vanadyl.service.impl.UserServiceImpl;
import com.vanadyl.util.HashUtils;
import com.vanadyl.util.IPUtils;
import com.vanadyl.util.JwtUtils;
import com.vanadyl.util.MailUtils;
import com.vanadyl.util.QQInfoUtils;
...
public class CommentController {
    ...
    public Result postComment(@RequestBody Comment comment,
        ...
        //父评论
        com.vanadyl.entity.Comment parentComment = null;
     ...
     */
    private void judgeSendMail(Comment comment, boolean isVisitorComment, com.vanadyl.entity.Comment parentComment) {
     ...
     * @param comment       当前评论
     */
    private void sendMailToParentComment(com.vanadyl.entity.Comment parentComment, Comment comment) {
        String path = "";
        String title = "";
        if (comment.getPage() == 0) {
            //普通博客
